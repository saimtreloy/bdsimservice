...
public class PackageAirtel extends AppCompatActivity {

    ButtonAwesome btnPackageAr1, btnPackageAr2, btnPackageAr3, btnPackageAr4, btnPackageAr5, btnPackageAr6,
            btnPackageAr7, btnPackageAr8, btnPackageAr9, btnPackageAr10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.package_airtel);
        setTitle("Airtel Packages");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_appbar_airtel);

        Initialization();

        CallButtonClicked(btnPackageAr1);
        CallButtonClicked(btnPackageAr2);
        CallButtonClicked(btnPackageAr3);
        CallButtonClicked(btnPackageAr4);
        CallButtonClicked(btnPackageAr5);
        CallButtonClicked(btnPackageAr6);
        CallButtonClicked(btnPackageAr7);
        CallButtonClicked(btnPackageAr8);
        CallButtonClicked(btnPackageAr9);
        CallButtonClicked(btnPackageAr10);

    }


    public void Initialization(){
        btnPackageAr1 = (ButtonAwesome) findViewById(R.id.btnPackageAr1);
        btnPackageAr1 = (ButtonAwesome) findViewById(R.id.btnPackageAr1);
        btnPackageAr2 = (ButtonAwesome) findViewById(R.id.btnPackageAr2);
        btnPackageAr3 = (ButtonAwesome) findViewById(R.id.btnPackageAr3);
        btnPackageAr4 = (ButtonAwesome) findViewById(R.id.btnPackageAr4);
        btnPackageAr5 = (ButtonAwesome) findViewById(R.id.btnPackageAr5);
        btnPackageAr6 = (ButtonAwesome) findViewById(R.id.btnPackageAr6);
        btnPackageAr7 = (ButtonAwesome) findViewById(R.id.btnPackageAr7);
        btnPackageAr8 = (ButtonAwesome) findViewById(R.id.btnPackageAr8);
        btnPackageAr9 = (ButtonAwesome) findViewById(R.id.btnPackageAr9);
        btnPackageAr10 = (ButtonAwesome) findViewById(R.id.btnPackageAr10);
    }
